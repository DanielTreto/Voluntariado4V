 ...
 */
final class Version20260116100230 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ORGANIZACION ADD avatar NVARCHAR(255)');
        $this->addSql('ALTER TABLE ORGANIZACION ALTER COLUMN telefono CHAR(9)');
        $this->addSql('ALTER TABLE VOLUNTARIO ADD avatar NVARCHAR(255)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ORGANIZACION DROP COLUMN avatar');
        $this->addSql('ALTER TABLE ORGANIZACION ALTER COLUMN TELEFONO NCHAR(9)');
        $this->addSql('ALTER TABLE VOLUNTARIO DROP COLUMN avatar');
