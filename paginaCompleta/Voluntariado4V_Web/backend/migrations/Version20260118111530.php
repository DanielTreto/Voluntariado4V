 ...
 */
final class Version20260118111530 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ORGANIZACION ADD direccion NVARCHAR(255)');
        $this->addSql('ALTER TABLE ORGANIZACION ADD web NVARCHAR(255)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE ORGANIZACION DROP COLUMN direccion');
        $this->addSql('ALTER TABLE ORGANIZACION DROP COLUMN web');
