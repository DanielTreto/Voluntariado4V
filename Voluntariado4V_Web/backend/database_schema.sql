...
CREATE TABLE ADMINISTRADOR (id NVARCHAR(20) NOT NULL, nombre NVARCHAR(50) NOT NULL, apellidos NVARCHAR(100) NOT NULL, correo NVARCHAR(100) NOT NULL, telefono NVARCHAR(20) NOT NULL, firebase_uid NVARCHAR(128) NOT NULL, foto NVARCHAR(255), PRIMARY KEY (id));
CREATE UNIQUE INDEX UNIQ_62B5A7C4F85E0677 ON ADMINISTRADOR (firebase_uid);
...
CREATE TABLE VOLUNTARIO (codvol NVARCHAR(20) NOT NULL, nombre NVARCHAR(30) NOT NULL, apellido1 NVARCHAR(30) NOT NULL, apellido2 NVARCHAR(30), correo NVARCHAR(50) NOT NULL, telefono NVARCHAR(9) NOT NULL, fecha_nacimiento DATE NOT NULL, descripcion NVARCHAR(500), dni NVARCHAR(9) NOT NULL, firebase_uid NVARCHAR(128) NOT NULL, estado NVARCHAR(10) NOT NULL, CODCICLO NVARCHAR(10) NOT NULL, PRIMARY KEY (codvol));
CREATE UNIQUE INDEX UNIQ_2AFD2CC1F85E0677 ON VOLUNTARIO (firebase_uid);
