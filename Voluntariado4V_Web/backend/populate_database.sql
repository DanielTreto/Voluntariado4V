...
IF NOT EXISTS (SELECT 1 FROM DISPONIBILIDAD WHERE CODVOL = 'vol001' AND DIA = 'LUNES' AND HORA = 'MAÑANA')
    INSERT INTO DISPONIBILIDAD (CODVOL, DIA, HORA) VALUES ('vol001', 'LUNES', 'MAÑANA');

IF NOT EXISTS (SELECT 1 FROM DISPONIBILIDAD WHERE CODVOL = 'vol001' AND DIA = 'JUEVES' AND HORA = 'TARDE')
    INSERT INTO DISPONIBILIDAD (CODVOL, DIA, HORA) VALUES ('vol001', 'JUEVES', 'TARDE');
