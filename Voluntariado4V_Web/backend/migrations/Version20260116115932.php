 ...
 */
final class Version20260116115932 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('EXEC [sp_rename] N\'ADMINISTRADOR.foto\', N\'avatar\'');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('EXEC [sp_rename] N\'ADMINISTRADOR.avatar\', N\'foto\'');
