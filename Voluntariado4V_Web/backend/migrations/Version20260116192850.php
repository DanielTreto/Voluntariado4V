 ...
 */
final class Version20260116192850 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE CREDENCIALES (id INT IDENTITY NOT NULL, user_type NVARCHAR(20) NOT NULL, correo NVARCHAR(180) NOT NULL, password NVARCHAR(255) NOT NULL, CODVOL INT, CODORG NVARCHAR(20), PRIMARY KEY (id))');
        ...
        $this->addSql('CREATE TABLE DISPONIBILIDAD (dia NVARCHAR(10) NOT NULL, hora NVARCHAR(10) NOT NULL, CODVOL INT NOT NULL, PRIMARY KEY (CODVOL, dia, hora))');
        ...
        $this->addSql('CREATE TABLE SOLICITUD (id INT IDENTITY NOT NULL, status NVARCHAR(20) NOT NULL, fecha_solicitud DATETIME2(6) NOT NULL, mensaje VARCHAR(MAX), CODVOL INT NOT NULL, CODACT INT NOT NULL, PRIMARY KEY (id))');
        ...
        $this->addSql('CREATE TABLE VOL_PREFIERE_TACT (CODVOL INT NOT NULL, CODTIPO INT NOT NULL, PRIMARY KEY (CODVOL, CODTIPO))');
        ...
        $this->addSql('ALTER TABLE ADMINISTRADOR ADD firebase_uid NVARCHAR(128)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX UNIQ_62B5A7C42FB49151 ON ADMINISTRADOR');
        ...
        $this->addSql('ALTER TABLE ADMINISTRADOR DROP COLUMN firebase_uid');
        $this->addSql('ALTER TABLE ADMINISTRADOR ALTER COLUMN id INT IDENTITY NOT NULL');
    }
}
