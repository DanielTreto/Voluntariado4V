...
public class OrganizationHistoryFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        historyList.add(new VolunteerActivity(
                "Maratón Solidario 2024", "Evento deportivo benéfico.", "Ciudad Deportiva", "2024-03-15", "4h", "2024-03-15", 50, "Deporte", "Finished", "Mi Organización", null, 0xFF009688, "https://images.unsplash.com/photo-1452626038306-9aae5e071dd3?ixlib=rb-4.0.3&auto=format&fit=crop&w=600&q=80"
        ));
